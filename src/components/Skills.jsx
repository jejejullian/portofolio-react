        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2>Skills</h2>
              <div className="bar">
                <Col xs={12} md={6} xl={5} className="icon-bar">
                  <img src={html} alt="icon bar" />
                  <img src={css} alt="icon bar" />
                  <img src={bootstrap} alt="icon bar" />
                </Col>
                <Col xs={12} md={6} xl={6} className="progress-bar bar1">
              ...
              <div className="bar">
                ...
                <Col xs={12} md={6} xl={6} className="progress-bar bar2">
                  <div className="labels">
                    <span>Beginner</span>
                    <span>Intermediate</span>
                    <span>Advanced</span>
              ...
              <div className="bar">
                ...
                <Col xs={12} md={6} xl={6} className="progress-bar bar3">
                  <div className="labels">
                    <span>Beginner</span>
                    <span>Intermediate</span>
                    <span>Advanced</span>
